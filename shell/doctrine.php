...
if (!defined('APPPATH'))
{
    define('APPPATH', '../private/_core/');
}

if (!defined('BASEPATH'))
{
    define('BASEPATH', '../private/_system/');
}
define('ENVIRONMENT', 'development');
require BASEPATH.'third_party/Doctrine/Doctrine.php';
...
$tool = new \Doctrine\ORM\Tools\SchemaTool($doctrine->em);
